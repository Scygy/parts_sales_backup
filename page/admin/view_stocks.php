...
<?php include 'plugins/sidebar/view_stocksbar.php'; ?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">View Stocks</li>
            </ol>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <div class="row">
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn" onclick="load_stocks()">Search <i class="fas fa-search"></i></button> 
                  </div>
                </div>
              </div>
                <div class="row">
                    <div class="col-sm-6">
                      &nbsp;<button class="btn btn-success " onclick="export_stocks('view_stocks')">Export</button>
                    </div>
                  </div>
              <!-- /.card-header -->
...
<?php include 'plugins/javascript/view_stocks_script.php'; ?>